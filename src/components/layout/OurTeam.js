    ...
    <section className="our-team-section__out">
      <section className="layout-section our-team-section">
        ...
        <TeamMemberCard teamMember={{
        	...
        	occupationDetails: "Fundador y CEO de TI Class Preuniversitario, con  más de 4000 alumnos año a año. ",
        	photo: nicolasMalgrejoImg,
        	description: "De profesión profesor, es el Autor del primer libro gratuito de PSU Física con más de 150.000 descargas. Se desempeñó como Gerente de innovación educativa y Jefe de Área Académica en OGR PuntajeNacional.cl Desarrolló sistemas de clases online en vivo desde el 2012 y la aplicación educativa PSU 850 con más de 500.000 descargas en Play Store.", }} />

        <TeamMemberCard teamMember={{
        	name: "Fabian Palacios",
        	occupation: "Especialista en marketing digital",
        	occupationDetails: "Fundador y CEO de Impulsados, Agencia de Marketing Digital la cual ayuda a empresas a poscionarse y vender por internet habiendo implementado + de 500 campañas publicitarias. ",
        	photo: fabianPalaciosImg,
        	description: "Desde 2018, ha capacitado en el área de marketing digital, destacando instituciones como Universidad Diego Portales, Universidad Tecnológica Metropolitana, Centros de Negocios Sercotec, Mujeres Emprendedoras, Mujeres del Pacífico, Social Marketing Academy,entre otros.",
        }}
	        order="inverse"
        />
